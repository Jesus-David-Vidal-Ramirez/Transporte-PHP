	...
	<section class="full-width navLateral">
		...
		<div class="full-width navLateral-body">
			...
			<figure class="full-width navLateral-body-tittle-menu">
				<div>
					<img src="cuerpo/img/avatar-male.png" alt="Avatar" class="img-responsive">
				</div>
				<figcaption>
					<span>
				...
				<ul class="full-width list-unstyle menu-principal">
					...
					<li class="full-width">
						...
						<ul class="full-width menu-principal sub-menu-options">
							...
							<li class="full-width">
								<a href="Provedores.php" class="full-width">
									<div class="navLateral-body-cl">
							...
							<li class="full-width">
								<a href="categorias.php" class="full-width">
									<div class="navLateral-body-cl">
...
<hr>
								<form method="POST" action="AgregarEmpleado.php">
									<hr>
								...
								<div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="email" id="E-mail">
								...
								<div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="text" id="Web">
										<label class="mdl-textfield__label" for="Web">Web</label>
								...
								<div class="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet">
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="tel" pattern="-?[0-9+()- ]*(\.[0-9]+)?" id="Fax">
								...
								<div class="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet">
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="text" id="Moneda">
										<label class="mdl-textfield__label" for="coinCompany">
											moneda</label>
							...
							<p class="text-center">
								<button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored bg-primary" id="btn-addCompany" name="registrarse">
